...
adata = pkl.load(open("Cell_Oracle/Resting_Fibro/021324/adata_oracle_resting_fibroblast_CO_021324.pkl", "rb"))
adata = adata.adata
...
folder_path_overlap = "Cell_Oracle/Resting_Fibro/021324/overlap_figures"
dataframe_dict_overlap = load_magnitude_csvs(folder_path_overlap)

folder_path_linked = "Cell_Oracle/Resting_Fibro/021324/linked_figures"
...
title = 'RF_HFvControl_Bubble'
output_file = 'Cell_Oracle/Resting_Fibro/021324/' + title + '.pdf'
plot_bubble_plot(df, title, output_file)
output_file = 'Cell_Oracle/Resting_Fibro/021324/size_legend.pdf'
...
# # for linked TFs
# ################################# load the cell oracle results #################################
# folder_path = "Cell_Oracle/Resting_Fibro/021324/linked_figures"
