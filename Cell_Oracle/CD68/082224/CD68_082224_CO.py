...
# Load the data
print(os.getcwd())
os.chdir("/ix/djishnu/Hanxi/MI_Spatial/Cell_Oracle/CD68/082224")

# loading the privious adata_oracle object and oracle_links object (both custom)
adata_oracle = dill.load(open('../020124/adata_oracle_CD68_CO_020124.pkl', 'rb'))
oracle_links = dill.load(open('../020124/CD68_oracle_links.pkl', 'rb'))

#%% ###################################################################
'''
Repeat 020124 analysis to save the oracle object post perturbation. 
...
for goi in linked_TF_list:
    ...
    dill.dump(adata_oracle, open('perturbed_oracle_objects/020124_CO/linked_objects/' + goi + '_adata_oracle.pkl', 'wb'))
...
for goi in linked_TF_list:
    ...
    dill.dump(adata_oracle, open('perturbed_oracle_objects/082224_CO/linked_objects/' + goi + '_adata_oracle.pkl', 'wb'))