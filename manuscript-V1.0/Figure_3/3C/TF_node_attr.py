...
# Read all .txt files 
txt_files = glob.glob('ER_SLIDE/AllFibro/081224/results/SLIDE_results/0.1_0.5_out_final/corr_network/*.txt')
dataframes = []
file_names = []
...
for df, file_name in zip(dataframes, file_names):
    ...
    output_filename = f"ER_SLIDE/AllFibro/081224/results/SLIDE_results/0.1_0.5_out_final/corr_network/{prefix}_node_attr.txt"
