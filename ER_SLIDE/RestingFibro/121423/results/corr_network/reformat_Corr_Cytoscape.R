...
# Example usage
folder_path <- "/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/RestingFibro/121423/results/corr_network/thresh_0_4"        # Specify your input folder path here
output_folder <- "/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/RestingFibro/121423/results/corr_network/cytoscape"    # Specify the output folder path here
