...
#setwd("/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/RestingFibro/121423/results/toy_networks")
output_path = "/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/RestingFibro/121423/results/corr_network/thresh_0_5"
layout = 'circular'
PlotCorNetwork(x, LF, threshold, layout = layout, output_path = output_path)


output_path = "/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/RestingFibro/121423/results/corr_network/thresh_0_5/spring"
layout = 'spring'
PlotCorNetwork(x, LF, threshold, layout = layout, output_path = output_path)
