...
# Read all .txt files 
txt_files = glob.glob('ER_SLIDE/Within_Region/121223_hf_mac/results/corr_network/cytoscape/*.txt')
dataframes = []
file_names = []
...
for df, file_name in zip(dataframes, file_names):
    ...
    output_filename = f"ER_SLIDE/Within_Region/121223_hf_mac/results/corr_network/cytoscape/{prefix}_node_attr.txt"
