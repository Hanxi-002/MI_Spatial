...
x_path <- "/ix/djishnu/Hanxi/MI_Spatial/Within_Region/052223_hf/x.csv"
er_path <- "/ix/djishnu/Hanxi/MI_Spatial/Within_Region/052223_hf/results/final_delta_0.01_lambda_0.5.rds"
out_path <- "/ix/djishnu/Hanxi/MI_Spatial/Within_Region/052223_hf/SLIDE_results/"

z_matrix <- CalcZMatrix(x_path, er_path, out_path)

y_path <- "/ix/djishnu/Hanxi/MI_Spatial/Within_Region/052223_hf/y.csv"
