...
# Example usage
folder_path <- "/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/Within_Region/091124_hf_CCR2/Results/0.01_0.5_out_final/corr_networks"        # Specify your input folder path here
output_folder <- "/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/Within_Region/091124_hf_CCR2/Results/0.01_0.5_out_final/corr_networks/cytoscape_2"    # Specify the output folder path here
...
# Run the function to process and save transformed networks as txt files
read_convert_and_save_txt(folder_path, output_folder)


# Now, transformed_csv_data is a named list where each element is a long-format data frame.
