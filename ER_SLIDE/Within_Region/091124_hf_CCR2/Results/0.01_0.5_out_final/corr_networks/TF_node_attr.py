...
# Read all .txt files 
txt_files = glob.glob('ER_SLIDE/Within_Region/091124_hf_CCR2/Results/0.01_0.5_out_final/corr_networks/cytoscape_2/*.txt')
dataframes = []
file_names = []
...
for df, file_name in zip(dataframes, file_names):
    ...
    output_filename = f"ER_SLIDE/Within_Region/091124_hf_CCR2/Results/0.01_0.5_out_final/corr_networks/cytoscape_2/{prefix}_node_attr.txt"
