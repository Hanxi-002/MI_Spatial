...
setwd("/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/CD68/121423")
library(doParallel)
library(ggplot2)
library(SLIDE)
library(SLIDEHelper)
...
y_path <- "Data/y.csv"
SLIDE_res <- SLIDEHelper::runSLIDE(y_path, z_path = NULL, z_matrix, er_path, do_interacts = TRUE, niter = 500, spec = 0.1)
