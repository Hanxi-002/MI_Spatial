...
write.csv(x, "/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/HF/CdVRest/121523/Data/x.csv")
write.csv(y, "/ix/djishnu/Hanxi/MI_Spatial/ER_SLIDE/HF/CdVRest/121523/Data/y.csv")
